...
class IMessengerRepositrory {
    ...
    getMessagesByRange(chatId, oldestMessageId, countMessages) {
        /*oldestMessageId назввание так себе, смысл что нажно вернуть count сообщений
    ...
    //todo: последние 4 метода можно обобщить по 2, нужно выделить сущьность обобщения
}
